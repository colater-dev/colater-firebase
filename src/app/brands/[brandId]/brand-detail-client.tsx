...
export function BrandDetailClient() {
    ...
    }, [brand, toast, brandRef, tryDeductCredits]);
    ...
    }, [brand, user, brandId, firestore, toast, logoConcept, provider, tryDeductCredits]);
    ...
    }, [currentLogo, user, brand, firestore, toast, brandId, tryDeductCredits]);
    ...
    }, [currentLogo, brand, user, firestore, brandId, toast, tryDeductCredits]);
    ...
    }, [currentLogo, user, firestore, brandId, toast, tryDeductCredits]);
